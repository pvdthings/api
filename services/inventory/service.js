...
const createItems = async (thingId, { quantity, brand, description, estimatedValue, hidden, condition, image }) => {
...
const updateItem = async (id, { brand, description, estimatedValue, hidden, condition, image }) => {
  let updatedFields = {};
